 ...
 */
	function roots_scripts() {
	  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/vinnie.css', false, 'c1a58eb4baaf24c3771085df3d54dd8d');
	  ...
	  wp_register_script('chart', get_template_directory_uri() . '/assets/js/vendor/chart.min.js', array(), '1.0.1-beta.3', true);
